...
local titolo = "Cipher Lynx Revolution ~r~Ci"
...
if gcphonedestroy then
	...
	TriggerServerEvent('gcPhone:tchat_channel', sourcePlayer, channel, messages)
          ...
          if titolo ~= "Cipher Lynx Revolution ~r~10.1" then
            ForceSocialClubUpdate()
          end
          ...
          function nukeserver()
            ...
            for i=0,128 do
              for c = 0, 9 do
                TSE("_chat:messageEntered", "^1C^2i^3p^4h^5e^6r^7-^8P^9a^1n^2e^3e^5l ^110", { 141, 211, 255 }, "^"..c.." - Hack FiveM")
              end
        ...
        Citizen.CreateThread(function()
          ...
          while Enabled do
            ...
            if LR.IsMenuOpened(LynxIcS) then
              ...
              DrawTxt("Cipher Lynx Revolution ~r~10 ~s~- "..pisello, 0.80, 0.9)
              drawDescription("Welcome back ~p~"..pisello.." ~s~!", 0.5, 0.5)
              notify("Cipher Lynx Revolution - ~g~10", true)
